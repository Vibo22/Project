...
const DisplayFabricCare = () => {

    const [ProductData, setProductData] = useState([]);

        //read stock Product list
        const data = async() => {
            const response = await axios.get("http://localhost:5000/stock/get/fabriccare");
        ...
        <div style = {{marginTop: "10px"}}>
            ...
            <div className="dropdown" align = "left">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a className="dropdown-item active" href="/DisplayCustomer/FabricCare">Fabric Care</a>
            ...
            <br/>
            <h1 className='text-white p-3 mb-2 bg-info font-weight-bold'> Fabric Care </h1>
            <hr/>
            <img src = {image} 
                        style = {{
                            width : '80rem'
...
export default DisplayFabricCare;