...
const DisplayCancelOrder = () => {
    ...
    const [CancelDeliveryList, setCancelDeliveryList] = useState([]);

    const data = async() => {
        const response = await Axios.get("http://localhost:5000/order/getcanceledorders");
        setCancelDeliveryList(response.data);
    };
        ...
        <div style = {{marginTop: "60px"}}>
            <div className='container'>
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/DisplayCancelOrder">Canceled Orders</a>
                    </li>
                    <li class="nav-item">
...
export default DisplayCancelOrder;